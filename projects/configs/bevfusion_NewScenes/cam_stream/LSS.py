...
data = dict(
    ...
    train=dict(
        ...
        test_mode=False,
        use_valid_flag=True,  #----mask filtering of useless targets in get_anno_info / here training and testing according to whether the image is visible
        box_type_3d='LiDAR'),
...
log_level = 'INFO'
work_dir = 'work_dirs/NewScenes_Final/LSS'
