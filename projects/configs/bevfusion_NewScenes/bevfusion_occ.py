...
model = dict(
    ...
    pts_bbox_head=dict(
        type='MultiTaskHeadv2',
        in_channels=256,
        out_channels=256,
        grid_conf=grid_conf,
        det_grid_conf=det_grid_conf,
        occ_grid_conf=occ_grid_conf,
        task_enbale={
            '3dod': False,
            'occ': True,
        },
...
#-------dataset----------
dataset_type = 'NewScenesDataset_MTL' 
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D', keys=['gt_bboxes_3d', 'gt_labels_3d','img','points','gt_occ','img_depth']) #---加入radar points---
]
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=False),
            dict(type='CustomCollect3D', keys=['img','points','gt_occ']) 
        ])
]
...
log_level = 'INFO'
work_dir = 'work_dirs/bevfusion_NewScenes_occ/'
