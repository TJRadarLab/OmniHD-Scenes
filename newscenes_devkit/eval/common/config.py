...
from newscenes_devkit.eval import detection, tracking
from newscenes_devkit.eval.detection.data_classes import DetectionConfig
from newscenes_devkit.eval.tracking.data_classes import TrackingConfig
